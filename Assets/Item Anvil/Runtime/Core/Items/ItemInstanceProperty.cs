    ...
    public abstract class ItemInstanceProperty : ICloneable
    {
        ...
        public override bool Equals(object obj)
        {
            return obj.GetType() == this.GetType() &&
                this.GetType().GetFields(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance).All(i =>
                { //Memberwise equality test. Not efficient, but easy to implement.
